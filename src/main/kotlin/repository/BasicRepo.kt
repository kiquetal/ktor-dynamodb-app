...
abstract class DynamoDbRepo<T:Entity>(private val tableName:String, private val klass:Class<T>, private val client:DynamoDbEnhancedAsyncClient): BasicRepo<T>
{
